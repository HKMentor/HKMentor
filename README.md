ront-end developer passionate about building smart, user-friendly apps. Currently working on a Resume Builder and learning Next.js, Tailwind CSS, and TypeScript.
